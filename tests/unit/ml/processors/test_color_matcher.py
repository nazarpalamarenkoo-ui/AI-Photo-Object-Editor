...
@pytest.mark.unit
def test_match_against_original_basic(color_matcher, test_image_with_bbox):
    """Test match_against_original returns valid bytes"""
    result_bytes, bbox = test_image_with_bbox
    original_bytes, _ = test_image_with_bbox

    out = color_matcher.match_against_original(
...
@pytest.mark.unit
def test_match_against_original_invalid_method(color_matcher, test_image_with_bbox):
    result_bytes, bbox = test_image_with_bbox
    original_bytes, _ = test_image_with_bbox

    with pytest.raises(ValueError, match="Unknown method"):
        color_matcher.match_against_original(
            result_bytes=result_bytes,
            original_image_bytes=original_bytes,
            bbox=bbox,
            method="invalid"
...
@pytest.mark.unit
def test_match_against_original_empty_context(color_matcher):
    """bbox covers full image → no context pixels"""
...
@pytest.mark.unit
def test_match_against_original_all_methods(color_matcher, test_image_with_bbox):
    result_bytes, bbox = test_image_with_bbox
    original_bytes, _ = test_image_with_bbox
